...
object-oriented programming, a simple graphical library (MLX or similar), and a modu-
| lar, reusable | architecture. |     |     |     |
| ------------- | ------------- | --- | --- | --- |
...
• The parameter PERFECT will be set to False to produce Pac-Man-compatible cor-
|     | ridors | (see          | A-Maze-ing |              | subject). |             |         |           |          |     |     |
| --- | ------ | ------------- | ---------- | ------------ | --------- | ----------- | ------- | --------- | -------- | --- | --- |
